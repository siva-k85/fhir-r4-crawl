---
url: https://hl7.org/fhir/R4/usecases.html
title: usecases.html
source: official_download
extracted: local_file_conversion
mirror_path: usecases.html
---
...
#  7.9 Common Example Scenarios in FHIR [](usecases.html#7.9 "link to here")
...
##  7.9.1 Personal Health Record (PHR) [](usecases.html#phr "link to here")
...
##  7.9.2 Document Sharing (XDS) [](usecases.html#xds "link to here")
...
##  7.9.3 Decision Support [](usecases.html#decision "link to here")
...
###  7.9.3.1 Explicit Requests for Decisions [](usecases.html#7.9.3.1 "link to here")
