---
url: https://hl7.org/fhir/R4/profiling.html
title: profiling.html
source: official_download
extracted: local_file_conversion
mirror_path: profiling.html
---
...
**Artifact** | **Description** | **[US Core![](external.png)](http://hl7.org/fhir/us/core) example**  
---|---|---  
Implementation Guide (IG) | A coherent and bounded set of adaptations that are published as a single unit. Validation occurs within the context of the Implementation Guide | [US Core IG ![](external.png)](http://hl7.org/fhir/us/core)  
Package | A group of related adaptations that are published as a group within an Implementation Guide | [US Core Capability Statements ![](external.png)](http://hl7.org/fhir/us/core/capstmnts.html)  
Conformance Resource | A single resource in a package that makes rules about how an implementation works. These are described below | [DAF Problem Value Set ![](external.png)](http://hl7.org/fhir/us/core/ValueSet-us-core-problem.html)  
Profile | A set of constraints on a resource represented as a structure definition with kind = `constraint` | [DAF Medication Request ![](external.png)](http://hl7.org/fhir/us/core/StructureDefinition-us-core-medicationrequest.html)  
...
###  5.1.0.8 Using StructureDefinitions [](profiling.html#using "link to here")
...
###  5.1.0.9 Differential vs Snapshot [](profiling.html#snapshot "link to here")
...
###  5.1.0.10 Slicing [](profiling.html#slicing "link to here")
...
###  5.1.0.11 Discriminator [](profiling.html#discriminator "link to here")
...
Within a structure definition, a slice is defined using multiple _element_ entries that share a _path_ but have distinct _name_ s. These entries together form a "slice group" that is: 
...
###  5.1.0.12 Slice Cardinality [](profiling.html#slice-cardinality "link to here")
...
###  5.1.0.13 Default Slice [](profiling.html#default-slice "link to here")
...
###  5.1.0.14 Re-profiling and Re-slicing [](profiling.html#reslicing "link to here")
...
###  5.1.0.15 Extension Definitions [](profiling.html#extensions "link to here")
...
####  5.1.0.15.1 Using Extensions in Profiles [](profiling.html#using-extensions "link to here")
...
###  5.1.0.16 Binding Definitions [](profiling.html#binding "link to here")
...
###  5.1.0.17 Mixing Custom and Standard Terminologies [](profiling.html#tx "link to here")
...
###  5.1.0.18 Changing Binding Strength in Profiles [](profiling.html#binding-strength "link to here")
...
derived (across)  
base (down) | required | extensible | preferred | example  
---|---|---|---|---  
...
###  5.1.0.19 Must Support [](profiling.html#mustsupport "link to here")
...
###  5.1.0.20 Search Criteria [](profiling.html#search "link to here")
...
###  5.1.0.21 Presenting Profiles [](profiling.html#presentation "link to here")
...
###  5.1.0.22 Supporting Multiple Profiles [](profiling.html#mixing "link to here")
Applications may be required to support more than one profile at a time. A typical example might be an EHR application that is required to support a general purpose data sharing profile (such as [DAF ![](external.png)](http://hl7.org/fhir/us/daf)), and also must support specific profiles for decision support using the same interface. 
...
Profiles can be compared to determine their compatibility. One such comparison can be found (Todo: bring this into the build) between [DAF ![](external.png)](http://hl7.org/fhir/us/daf) and [QICore ![](external.png)](http://hl7.org/fhir/us/qicore). Note that this comparison is generated by tooling under ongoing development, and is purely draft content to demonstrate the idea of profile comparison. 
®© HL7.org 2011+. FHIR Release 4 (Technical Correction #1) (v4.0.1) generated on Fri, Nov 1, 2019 09:37+1100. [QA Page](qa.html)   
Links: [Search ![](external.png)](http://hl7.org/fhir/search.cfm) | [Version History](history.html) | [Table of Contents](toc.html) | [Credits](credits.html) | [Compare to R3 ![](external.png)](http://services.w3.org/htmldiff?doc1=http%3A%2F%2Fhl7.org%2Ffhir%2FSTU3%2Fprofiling.html&doc2=http%3A%2F%2Fbuild.fhir.org%2Fprofiling.html) | [![CC0](cc0.png)](license.html) | [Propose a change ![](external.png)](http://hl7.org/fhir-issues)
