---
url: https://hl7.org/fhir/R4/messaging.html
title: messaging.html
source: official_download
extracted: local_file_conversion
mirror_path: messaging.html
---
...
#  3.4 Messaging using FHIR Resources [](messaging.html#3.4 "link to here")
...
---|---|---  
FHIR Resources can be used in a traditional messaging context, much like [HL7 v2 ![](external.png)](http://www.hl7.org/implement/standards/product_brief.cfm?product_id=185) (see [detailed comparison](comparison-v2.html)). Applications asserting conformance to this framework claim to be conformant to "FHIR messaging" (see [Conformance](conformance-rules.html)). 
...
##  3.4.1 Basic Messaging Assumptions [](messaging.html#basic "link to here")
...
####  3.4.1.1.1 Example: Elevation from Notification to Consequence [](messaging.html#3.4.1.1.1 "link to here")
...
###  3.4.1.2 Implication to Receiver [](messaging.html#3.4.1.2 "link to here")
...
###  3.4.1.3 Message Exchange Patterns [](messaging.html#patterns "link to here")
...
####  3.4.1.3.1 Synchronous [](messaging.html#sync "link to here")
...
####  3.4.1.3.2 Asynchronous [](messaging.html#async "link to here")
...
###  3.4.1.4 MessageHeader Identifiers & Timestamps [](messaging.html#3.4.1.4 "link to here")
...
###  3.4.1.5 Absence of Reliable Messaging [](messaging.html#reliable "link to here")
...
####  3.4.1.5.1 Example: Consequence [](messaging.html#3.4.1.5.1 "link to here")
...
####  3.4.1.5.2 Example: Currency [](messaging.html#3.4.1.5.2 "link to here")
...
##  3.4.2 Capability Statement [](messaging.html#conf "link to here")
...
##  3.4.3 $process-message [](messaging.html#process "link to here")
...
##  3.4.4 Relationship between Messaging and REST [](messaging.html#endpoints "link to here")
...
###  3.4.4.1 Asynchronous Messaging using the RESTful API [](messaging.html#rest "link to here")
...
##  3.4.5 Defining Events [](messaging.html#events "link to here")
...
##  3.4.6 Invoking Operations via Messages [](messaging.html#operations "link to here")
...
###  3.4.6.1 Invoking Search via Messages [](messaging.html#search "link to here")
