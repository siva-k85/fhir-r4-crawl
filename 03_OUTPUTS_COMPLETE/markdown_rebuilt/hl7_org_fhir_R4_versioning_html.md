---
url: https://hl7.org/fhir/R4/versioning.html
title: versioning.html
source: official_download
extracted: local_file_conversion
mirror_path: versioning.html
---
...
##  2.8 Managing Multiple FHIR Versions [](versioning.html#2.8 "link to here")
...
---|---|---  
This FHIR specification is one in a [series of publications of the FHIR specification ![](external.png)](http://hl7.org/fhir/directory.html). There have been previous releases, and there will be subsequent releases. Each release (or "version") introduces new features, and changes from the previous releases. 
...
###  2.8.1 CapabilityStatement.fhirVersion [](versioning.html#cs-version "link to here")
...
###  2.8.2 Mime Type Parameter [](versioning.html#mt-version "link to here")
...
###  2.8.3 Version Specific Profile [](versioning.html#mp-version "link to here")
...
###  2.8.4 Managing Version Identification [](versioning.html#managing "link to here")
...
###  2.8.5 Strategies for handling Changes Between Versions [](versioning.html#changes "link to here")
...
A key aspect of the FHIR specification development process is gaining feedback from implementers making use of the specification. As well, the process is conditional on real world implementation in order to move through the maturity cycle. For this reason, all FHIR implementers are encouraged to register their usage [here ![](external.png)](http://fhir.org/implementations/usage), which captures contact and other information that will allow HL7 to perform appropriate monitoring of FHIR usage. Survey information is confidential and reported in aggregate only. (Note that implementers can advertise their use of FHIR [here ![](external.png)](http://fhir.org/implementations/usage). 
®© HL7.org 2011+. FHIR Release 4 (Technical Correction #1) (v4.0.1) generated on Fri, Nov 1, 2019 09:37+1100. [QA Page](qa.html)   
Links: [Search ![](external.png)](http://hl7.org/fhir/search.cfm) | [Version History](history.html) | [Table of Contents](toc.html) | [Credits](credits.html) | [Compare to R3 ![](external.png)](http://services.w3.org/htmldiff?doc1=http%3A%2F%2Fhl7.org%2Ffhir%2FSTU3%2Fversioning.html&doc2=http%3A%2F%2Fbuild.fhir.org%2Fversioning.html) | [![CC0](cc0.png)](license.html) | [Propose a change ![](external.png)](http://hl7.org/fhir-issues)
