---
url: https://hl7.org/fhir/R4/json.html
title: json.html
source: official_download
extracted: local_file_conversion
mirror_path: json.html
---
...
##  2.6.2 JSON Representation of Resources [](json.html#2.6.2 "link to here")
...
---|---  
The JSON representation for a resource is based on the [JSON format described in STD 90 (RFC 8259) ![](external.png)](https://www.rfc-editor.org/info/std90), and is described using this format: 
```
{
  "resourceType" : "[**[Resource Type]**](resourcelist.html "The resource type being referenced")",
  // from Source[](json.html): property0[](json.html)
  "property1[](json.html "long description")" : "<[primitive][](datatypes.html)>", // short description
  "property2[](json.html "long description")" : { [Data Type][](datatypes.html) }, // short description
  "property3[](json.html "long description")" : { // Short Description
    "propertyA[](json.html "long description")" : { CodeableConcept[](datatypes.html#CodeableConcept) }, // Short Description[](json.html) (Example[](terminologies.html#example))
  },
  "property4[](json.html "long description")" : [{ // Short Description
    "propertyB[](json.html "long description")" : { Reference[](references.html#Reference)(ResourceType[](resourcelist.html)) } // **R!**  Short Description
  }]
}
...
###  2.6.2.1 Comparison with XML [](json.html#xml "link to here")
...
###  2.6.2.2 JSON Representation for repeating elements [](json.html#repeat "link to here")
...
###  2.6.2.3 JSON representation of primitive elements [](json.html#primitive "link to here")
...
###  2.6.2.5 JSON representation of Resources [](json.html#resources "link to here")
