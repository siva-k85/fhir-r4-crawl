...
**File Size Range**: 10.5KB - 699KB per file
...
All configuration files are preserved in `02_CONFIGURATION/CONFIG/`:
...
### Reproducibility
All inputs preserved in `02_CONFIGURATION/CONFIG/`:
...
**Reproducible**: Yes (see 02_CONFIGURATION/CONFIG/ for all inputs)
